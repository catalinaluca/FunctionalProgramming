...
public class CrazyLambdas {
    ...
    public static UnaryOperator<Function<String, String>> composeWithTrimFunction() {
        return (fct) -> fct.compose(String::trim);
    }
    ...
    public static Consumer<Runnable> newThreadRunnableConsumer() {
        return runnable -> new Thread(runnable).run();
    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        return (intUnaryOperator, intPredicate) -> (number -> intPredicate.test(number) ? intUnaryOperator.applyAsInt(number) : number);
    }
        ...
        return (map, string) -> {
            if (map.containsKey(string)) {
                for (Map.Entry<String, IntUnaryOperator> entry : map.entrySet()) {
                    if (entry.getKey().equals(string)) return entry.getValue();
                }
            }
